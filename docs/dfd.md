...
3.0 → Director — Project Status Data
3.0 → RET Chair — Project Status Data
3.0 → Faculty — Project Status Data

---

*Process 4.0 — Manage Project Proposals*

Faculty → 4.0 — Project Documents
RET Chair → 4.0 — Project Documents
...
RET Chair → 7.0 — Project Management Data
Director → 7.0 — Project Management Data
6.0 → 7.0 — Approved Proposal Record
5.0 → 7.0 — Verified MOA Reference
...
Faculty → 8.0 — Project Documents
RET Chair → 8.0 — Project Documents
7.0 → 8.0 — Active Project Context
...
*LEVEL 1 DFD — Process 1.0: Manage User Accounts (Revised)*
...
*LEVEL 1 DFD — Process 2.0: Manage System Access (Revised)*
...
2.6 → D1 — Updated Password Hash
2.6 → D7 — Invalidated OTP Record
2.6 → 2.3 — Password Reset Event Data

*Sub-processes:*
- *2.1 — Process Account Registration* — handles self-registration, provisioned login, and password reset requests
...
- *2.4 — Process Password Reset Request* — validates email, generates and sends OTP
- *2.5 — Validate OTP* — validates submitted OTP against stored OTP record
- *2.6 — Update Password* — validates password match, updates password hash, invalidates OTP

---

*LEVEL 1 DFD — Process 3.0: Monitor Dashboard (Revised)*
...
*LEVEL 1 DFD — Process 4.0: Manage Project Proposals (Revised)*
...
*LEVEL 1 DFD — Process 5.0: Manage MOA Records (Revised)*
...
*LEVEL 1 DFD — Process 6.0: Evaluate Project Proposal (Revised)*
...
6.4 → 6.5 — Evaluation Event Data
6.5 → D6 — System Event Record
...
- *6.5 — Record Evaluation Event* — records all evaluation events in D6

---

*LEVEL 1 DFD — Process 7.0: Manage Projects (Revised)*
...
7.2 → 7.3 — Project Initialization Data
Director → 7.3 — Reporting Frequency
Director → 7.3 — Reporting Dates
7.3 → D4 — Project Reporting Schedule
7.3 → 7.4 — Project State Update
7.4 → D4 — Active Project Context
7.4 → D4 — Aggregated Project Data
7.4 → 7.5 — Project Event Data
7.5 → D6 — System Event Record
...
- *7.3 — Store Reporting Schedule* — validates and stores project reporting schedule
- *7.4 — Route Project Context* — routes active project context and aggregated project data to D4
- *7.5 — Record Project Event* — records project activation and implementation update events in D6

---

*LEVEL 1 DFD — Process 8.0: Manage Project Reports (Revised)*
...
*Sub-processes:*
- *8.1 — Verify Active Project* — verifies active project context and reporting schedule from D4
...
- *8.5 — Record Report Event* — records report submission and project closure events in D6

---

*LEVEL 1 DFD — Process 9.0: Manage Activity Logs (Revised)*
