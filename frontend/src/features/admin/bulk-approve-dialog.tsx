  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent
        ...
        className="h-[540px] w-[95vw] max-w-[1000px] max-h-[calc(100vh-2rem)] overflow-hidden rounded-[10px] border border-[#e5e5e5] bg-white p-0 ring-0 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] sm:max-w-[1000px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
      >
