...
export default function ProjectsChartCard({
	...
	return (
		<div className="h-[370px] overflow-hidden rounded-[12px] border border-border bg-white shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]">
			<div className="flex h-[72px] items-start justify-between border-b border-white px-6 pt-4 pb-3">
				<div className="leading-tight">
					...
					<p className="text-[14px] leading-5 text-muted-foreground">per college</p>
				</div>
				<Select
					...
					modal={false}
				>
					<SelectTrigger className="h-9 w-[200px] rounded-md border border-border bg-white px-3 text-[14px] text-muted-foreground shadow-[0px_1px_1px_rgba(0,0,0,0.1)]">
