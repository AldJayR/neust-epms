			...
			<div className="flex flex-col gap-8">
				...
				<div className="grid gap-6 md:grid-cols-3">
					{[1, 2, 3].map((i) => (
						<div
							key={i}
							className="h-[104px] rounded-[12px] border border-[#ebebeb] bg-background p-4 flex flex-col gap-4 shadow-[0px_1px_3px_0px_var(--shadow-card)]"
						>
				...
				<div className="rounded-[12px] border border-[#ebebeb] bg-background overflow-hidden min-h-[400px] shadow-[0px_1px_3px_0px_var(--shadow-card)] p-4 flex flex-col gap-4">
