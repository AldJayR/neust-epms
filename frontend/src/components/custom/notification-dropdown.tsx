...
function getNotificationIcon(type: string) {
	...
	switch (type) {
		...
		case "schedule_adjustment_approved":
			return <Calendar className={cn(iconClassName, "text-blue-500")} />;
		case "proposal_status_update":
			return <FileSignature className={cn(iconClassName, "text-indigo-500")} />;
		case "account_activated":
			return <UserCheck className={cn(iconClassName, "text-emerald-500")} />;
		default:
